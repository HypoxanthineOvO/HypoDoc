...
| Cycle | 目的 | 状态 | 结果 |
| --- | --- | --- | --- |
| [C004-v0.2.0-stable-release](C004-v0.2.0-stable-release/CYCLE.md) | 将已接受的 RC 候选验证并发布为稳定版 `v0.2.0` | completed | GitHub stable Release 含 9 个附件；CI/Build Hosts 全绿；GitLab mirror 已同步；见 `SUMMARY.md` |
