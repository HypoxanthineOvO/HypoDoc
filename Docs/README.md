...
Product architecture, contributor guidance, compatibility matrices, and
release documentation will live here.

The migration procedure currently lives in the repository root at
`MIGRATION.md`.
